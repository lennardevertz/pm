...
// const CONTRACT_CREATION_BLOCK = 5811853; // Block when SourceAsserter was created
...
async function assertSource() {
    ...
    if (!topicId || !label || /* !url */ !sourceDesc) {
        showStatus("Please fill Topic ID, Label, and Source Description. URL is optional.", true);
        return;
    }
